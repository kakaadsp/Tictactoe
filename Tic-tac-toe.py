...
class TicTacToe:
    ...
    [(0, 0), (0, 1), (0, 2)],  # Baris atas
    [(1, 0), (1, 1), (1, 2)],  # Baris tengah
    [(2, 0), (2, 1), (2, 2)],  # Baris bawah
    [(0, 0), (1, 0), (2, 0)],  # Kolom kiri
    [(0, 1), (1, 1), (2, 1)],  # Kolom tengah
    [(0, 2), (1, 2), (2, 2)],  # Kolom kanan
    [(0, 0), (1, 1), (2, 2)],  # Diagonal kiri atas ke kanan bawah
    [(0, 2), (1, 1), (2, 0)]   # Diagonal kanan atas ke kiri bawah  
]
